import{r as n,j as e}from"./jsx-runtime-BiXka7E7.js";import{c as y,B as k,a as w,u as T,w as N,T as z,b as C}from"./index-BwWm0JV9.js";import{I as E,F as H}from"./ImportButton-BcqHX3kq.js";import{l as $,n as S,o as B,p as I,_ as V,L as j,O,M as D,q as R,S as F}from"./components-CZmywKMH.js";import{L as W}from"./loader-circle-BRNhzI2j.js";import"./slug-DE7USKAG.js";/**
 ...
 *
 * @license MIT
 */let M="positions";function q({getKey:a,...i}){let{isSpaMode:o}=$(),d=S(),h=B();I({getKey:a,storageKey:M});let c=n.useMemo(()=>{if(!a)return null;let u=a(d,h);return u!==d.key?u:null},[]);if(o)return null;let m=((u,r)=>{if(!window.history.state||!window.history.state.key){let t=Math.random().toString(32).slice(2);window.history.replaceState({key:t},"")}try{let l=JSON.parse(sessionStorage.getItem(u)||"{}")[r||window.history.state.key];typeof l=="number"&&window.scrollTo(0,l)}catch(t){console.error(t),sessionStorage.removeItem(u)}}).toString();return n.createElement("script",V({},i,{suppressHydrationWarning:!0,dangerouslySetInnerHTML:{__html:`(${m})(${JSON.stringify(M)}, ${JSON.stringify(c)})`}}))}const A=n.createContext(void 0),b="md-studio-theme";function _(){return typeof window>"u"?"light":window.matchMedia("(prefers-color-scheme: dark)").matches?"dark":"light"}function J({children:a}){const[i,o]=n.useState(()=>{if(typeof window>"u")return"system";const r=localStorage.getItem(b);return r&&["dark","light","system"].includes(r)?r:"system"}),[d,h]=n.useState(()=>{if(typeof window>"u")return"light";const r=localStorage.getItem(b),t=r&&["dark","light","system"].includes(r)?r:"system";return t==="system"?_():t}),[c,m]=n.useState(!1);n.useEffect(()=>{m(!0)},[]),n.useEffect(()=>{const r=document.documentElement,t=i==="system"?_():i;h(t),r.classList.remove("light","dark"),r.classList.add(t)},[i]),n.useEffect(()=>{if(i!=="system")return;const r=window.matchMedia("(prefers-color-scheme: dark)"),t=()=>{const l=_();h(l),document.documentElement.classList.remove("light","dark"),document.documentElement.classList.add(l)};return r.addEventListener("change",t),()=>r.removeEventListener("change",t)},[i]);const u=r=>{o(r),localStorage.setItem(b,r)};return c?e.jsx(A.Provider,{value:{theme:i,setTheme:u,resolvedTheme:d},children:a}):e.jsx(e.Fragment,{children:a})}function P(){const a=n.useContext(A);return a===void 0?{theme:"system",setTheme:()=>{},resolvedTheme:"light"}:a}/**
